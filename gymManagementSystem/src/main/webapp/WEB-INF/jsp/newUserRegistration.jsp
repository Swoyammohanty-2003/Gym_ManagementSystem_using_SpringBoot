...
<body>
	<div class="container">
		...
		<form:form id="registration-form" method="post"
    ...
    Enter first name: <form:input path="firstName"
			...
			<br />
			<br />
    Enter last name: <form:input path="lastName" placeholder="Last Name"
				required="required" />
			<br />
			<br />
    Enter email: <form:input path="email" id="email"
			...
			<br />
			<br />
    Select User's Type: <form:input list="types" name="type" path="type"
				placeholder="User Type" required="required" />
			<datalist id="types">
    ...
    Enter user Id: <form:input path="username" id="username"
			...
			<br />
			<br />
    Enter Phone No.: <form:input path="phone_number" id="phone_number"
				type="tel" maxlength="10" pattern="\d{10}"
				placeholder="Phone Number" required="required" />
			<br />
			<br />
    Enter password: <form:input type="password" path="password"
				id="pass1" placeholder="Password" required="required" />
			<br />
			<br />
